...
ssize_t __generic_file_aio_write(struct kiocb *, const struct iovec *, unsigned long);
ssize_t generic_file_aio_write(struct kiocb *, const struct iovec *, unsigned long, loff_t);
ssize_t generic_file_direct_write(struct kiocb *, const struct iovec *,
...
ssize_t default_file_splice_read(struct file *, loff_t *,
				 struct pipe_inode_info *, size_t,
				 unsigned int);
ssize_t generic_file_splice_write(struct pipe_inode_info *,
